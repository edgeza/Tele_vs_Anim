...
import {
  NotosansRegularNormalWhite15px,
  NotosansRegularNormalWhite14px,
  RobotoRegularNormalWhite32px,
} from "../../styledMixins";
...
function Frame23(props) {
  ...
  return (
    <Frame className={`frame-243 ${className || ""}`}>
      <Frame1 className="frame-244">
        <Frame2 className="frame-245">
          <Frame3 className="frame-246">
            <Frame22>{frame22Props.children}</Frame22>
            <Frame4 className="frame-247">
              <Frame5 className="frame-248">
                <Frame6 className="frame-249">
                  <Frame7 className="frame-250">
                    <Frame8 className="frame-251">
                      <Frame9 className="frame-252">
                        <Text35 className="text-35"></Text35>
                      </Frame9>
                    </Frame8>
                  </Frame7>
              ...
              <Frame10 className="frame-253">
                <Frame11 className="frame-254">
