...
import { NotosansRegularNormalWhite15px } from "../../styledMixins";
...
function Frame21(props) {
  ...
  return (
    <Frame className={`frame-228 ${className || ""}`}>
      <Frame1 className="frame-229">
        <Frame2 className="frame-230">
          <Frame3 className="frame-231">
            <Frame22>{frame22Props.children}</Frame22>
            <Frame4 className="frame-232">
              <Frame5 className="frame-233">
                <Frame6 className="frame-234">
