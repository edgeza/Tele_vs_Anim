...
import {
  NotosansRegularNormalBlueberry14px,
  RobotoRegularNormalWhite20px,
  NotosansBoldVulcan24px,
  NotosansMediumGulfBlue16px,
  NotosansRegularNormalAlabaster18px,
  NotosansRegularNormalWhite14px2,
                                ...
                                <Frame106>
                                  <Frame107>
                                    ...
                                    <IAcceptThePrivacy>
                                      ...
                                      <span className="notosans-regular-normal-blueberry-14px">{spanText2}</span>
                                    </IAcceptThePrivacy>
                                  </Frame107>
                                </Frame106>
                              </Frame105>
                ...
                <Frame118>
                  ...
                  <Frame119>
                    <Frame116>
                      ...
                      <WhatsApp>
                        <span className="roboto-regular-normal-white-20px">{spanText3}</span>
                        <span className="notosans-regular-normal-white-14px">{spanText4}</span>
                      </WhatsApp>
                    </Frame116>
                    <Frame120>
              ...
              <OverlapGroup1>
                ...
                <Frame128>
                  <UserAgreementSitemap>
                    <span className="notosans-regular-normal-sea-serpent-14px">{spanText5}</span>
                    <span className="notosans-regular-normal-white-14px">{spanText6}</span>
                    <span className="notosans-regular-normal-sea-serpent-14px">{spanText7}</span>
                  </UserAgreementSitemap>
                </Frame128>
              </OverlapGroup1>
            </Frame127>
...
const CallMeBack = styled.div`
  align-self: stretch;
  margin-top: -2px;
  font-family: var(--font-family-noto_sans-bold);
  font-weight: 700;
  color: var(--white);
